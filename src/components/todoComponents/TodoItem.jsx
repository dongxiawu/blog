    ...
    return (
      <div className="col-md-12 col-xs-12 todo-item-container" ref="itemContainer" value={ this.props.id }>
        <div className="col-md-2 col-xs-4 icon-box">
          <span className="glyphicon glyphicon-ok" style={ iconStyle } onClick={ this.toggleClickHandle } />
        </div>
        ...
        <div className="col-md-1 col-xs-2 text-right">
          <span className="glyphicon glyphicon-remove icon-remove" onClick={ this.deleteClickHandle } />
        </div>
      </div>
    );
  }
